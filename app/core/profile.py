...
def build_transcribe_config() -> CoreTranscribeConfig:
    ...
    return CoreTranscribeConfig(
        ...
        whisper_service_base=cfg.whisper_service.base_url,
        whisper_service_encode=cfg.whisper_service.encode,
        whisper_service_task=cfg.whisper_service.task,
        whisper_service_vad_filter=cfg.whisper_service.vad_filter,
        whisper_service_output=cfg.whisper_service.output,
        whisper_service_prompt=cfg.whisper_service.prompt,
