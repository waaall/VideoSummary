---
layout: page
title: VideoSummary - 基于LLM的智能视频字幕处理工具
titleTemplate: false
...
head:
  - - meta
    - name: keywords
      content: VideoSummary,卡卡字幕助手,视频字幕生成器,AI自动字幕,Whisper中文字幕,LLM字幕翻译,免费字幕工具,开源字幕软件,视频转文字,语音识别字幕,B站字幕生成,YouTube字幕工具,多语言字幕,字幕断句优化,视频字幕处理,自动生成字幕,字幕制作软件,视频配字幕
  - - meta
    - property: og:title
      content: VideoSummary - 基于LLM的智能视频字幕处理工具 | 免费开源
  - - meta
